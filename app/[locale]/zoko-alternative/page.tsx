...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Zoko costs $34.99–$149/mo. These alternatives offer the same Shopify WhatsApp automation at lower prices — some with better team inbox and analytics.",
    type: "article",
  },
  alternates: {
...
const TOOLS = [
  {
    ...
    channels: ["WhatsApp"],
    pros: [
      "₹999/mo vs Zoko's $34.99/mo — 3x cheaper",
  ...
  },
  {
    rank: 2,
    name: "ReplyKaro",
    tagline: "Best for WhatsApp + Instagram Together",
    badge: "Multi-Channel",
    badgeColor: "bg-blue-100 text-blue-700",
    price: "Free forever · ₹99/mo paid",
    bestFor: "D2C brands who run both WhatsApp marketing and Instagram DM automation and want one tool for both",
    channels: ["WhatsApp", "Instagram", "Facebook"],
    pros: [
      "Free Forever plan — no credit card needed",
      "₹99/mo flat — vs Zoko's $34.99+ with usage charges",
      "WhatsApp + Instagram in one platform",
      "INR billing via UPI (no forex/GST on USD)",
      "Comment-to-DM and WhatsApp flow automation",
    ],
    cons: ["E-commerce flows less specialized than Zoko", "Shopify integration still developing"],
    rating: 4.3,
  },
  {
    rank: 3,
    ...
    price: "₹999/mo ($12)",
    bestFor: "E-commerce brands running bulk WhatsApp promotions, sale announcements, and customer retargeting",
    channels: ["WhatsApp"],
    pros: [
      "Bulk broadcast to large customer lists",
      "Retargeting campaigns based on website behaviour",
      "Green tick WhatsApp Business Account support",
      "Chatbot flows for FAQs and order tracking",
      "Strong analytics on delivery, open, and reply rates",
    ],
    cons: ["No checkout or cart recovery automation", "No team inbox for support agents"],
    rating: 4.2,
  },
  {
    rank: 4,
    ...
    price: "$49/mo",
    bestFor: "Mid-market teams needing robust automation flows, CRM integrations, and dedicated support",
    channels: ["WhatsApp"],
    pros: [
      "Mature platform with strong automation builder",
    ...
    cons: ["$49/mo minimum — expensive for small stores", "WhatsApp only, no other channels"],
    rating: 4.1,
  },
  {
    rank: 5,
